...
public class HTdriver {
    public static void main(String[] args) {
        ...
        // I hope to make a hashmap implementation soon
         ...
         */
        HashTable1 HT = new HashTable1(3);
        HT.insert("Eriq");
        HT.insert("Eriq");
        HT.insert("Eriq");
        HT.insert("Eriq");
        ...
        HT.insert("Hash Table");
        HT.insert("Secret message");
        System.out.println(HT.search("Eriq")); // true
        HT.insert("hire me lol");
        System.out.println(HT.search("hire me lol")); // true
        HT.printList();
        HT.remove("Eriq");
        HT.remove("hire me lol");
        HT.printList();
        System.out.println(HT.search("Eriq")); // false
        System.out.println(HT.search("hire me lol")); // false
